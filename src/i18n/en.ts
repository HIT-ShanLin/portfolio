...
export const en: Translations = {
  ...
  about: {
    title: 'About Me',
    paragraphs: [
      'I am a Systems Engineer at Tencent, focused on large-scale distributed systems and cloud infrastructure. I hold a Master\'s degree in Computer Science from Harbin Institute of Technology (HIT), with a solid foundation in computer architecture, operating systems, computer networks, and distributed systems.',

      'My primary languages are Rust, C/C++, Python, and Go, with strong systems programming skills and code quality awareness. At Tencent, I contributed to edge AI inference engine performance optimization and heterogeneous hardware adaptation, as well as the design and implementation of a large-scale CDN rule engine — building solid experience in system-level performance tuning and high-concurrency engineering.',
